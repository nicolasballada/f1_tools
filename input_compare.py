...
def throttle_brake(session, driver1, driver2, t1_color, t1_inv_color, t2_color, t2_inv_color):
    ...
    ax.plot((d1_tel["Distance"] / 1000), d1_tel["Throttle"],
            color=t1_color, label=f"{driver1.identifier} Acc")
    ax.plot((d2_tel["Distance"] / 1000), d2_tel["Throttle"],
            color=t2_color, label=f"{driver2.identifier} Acc")
    ax.plot((d1_tel["Distance"] / 1000), ((d1_tel["Brake"] + 1) * - 10),
            color=t1_inv_color, label=f"{driver1.identifier} Dec")
    ax.plot((d2_tel["Distance"] / 1000), ((d2_tel["Brake"] + 1) * - 10),
            color=t2_inv_color, label=f"{driver2.identifier} Dec")
